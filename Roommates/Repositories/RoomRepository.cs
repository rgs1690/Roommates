...
{
  // --XML xtensible mark up lanuage, below, has three slashes and allows visual studio to have info about the function so when you hover over it defines what the function does. DOCUMENTATION 
    /// <summary>   
        ...
        public void Update(Room room)
        {
            using (SqlConnection conn = Connection)
            {
                ...
                using (SqlCommand cmd = conn.CreateCommand())
                {
                    ...
                    cmd.ExecuteNonQuery(); //ExecuteNonQuery for Updates, Execute reader for select this will not return anything for an update
                }
            }
        }
        /// <summary>
